                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <h2 style={{ color: mode === 'dark' ? '#ff4162' : '' }} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Ansh Aggarwal</h2>
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="text-gray-500">Web Designer Designer</p>
                            </div>
                        </div>
